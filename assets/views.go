...
func assetsViewHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/view.html", size: 2175, mode: os.FileMode(420), modTime: time.Unix(1486394029, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsViewsGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/views.go", size: 20480, mode: os.FileMode(420), modTime: time.Unix(1486394031, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
